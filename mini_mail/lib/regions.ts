...
const raw: Record<string, Record<string, string[]>> = {
  "北京市": { "北京城区": ["东城区","西城区","朝阳区","海淀区","丰台区","石景山区","通州区","大兴区","顺义区","昌平区","房山区","门头沟区","平谷区","怀柔区","密云区","延庆区"] },
  "天津市": { "天津城区": ["和平区","河东区","河西区","南开区","河北区","红桥区","滨海新区","东丽区","西青区","津南区","北辰区","武清区","宝坻区","宁河区","静海区","蓟州区"] },
  "上海市": { "上海城区": ["黄浦区","徐汇区","长宁区","静安区","普陀区","虹口区","杨浦区","闵行区","宝山区","嘉定区","浦东新区","金山区","松江区","青浦区","奉贤区","崇明区"] },
  "重庆市": { "重庆城区": ["渝中区","江北区","南岸区","沙坪坝区","九龙坡区","大渡口区","北碚区","渝北区","巴南区","涪陵区","长寿区","江津区","合川区","永川区","南川区","綦江区","大足区","璧山区","铜梁区","潼南区","荣昌区","开州区","梁平区","武隆区","万州区","黔江区"] },
  "河北省": {
    "石家庄市": ["长安区","桥西区","新华区","裕华区","井陉矿区","藁城区","鹿泉区","栾城区","正定县","行唐县","灵寿县","高邑县","深泽县","赞皇县","无极县","平山县","元氏县","赵县","辛集市","晋州市","新乐市"],
    ...
    "保定市": ["竞秀区","莲池区","满城区","清苑区","徐水区","涿州市","定州市","安国市","高碑店市","涞水县","阜平县","定兴县","唐县","高阳县","容城县","涞源县","望都县","易县","曲阳县","蠡县","顺平县","博野县","雄县","安新县"],
  ...
  "内蒙古自治区": {
    ...
    "乌兰察布市": ["集宁区","卓资县","化德县","商都县","兴和县","凉城县","察哈尔右翼前旗","察哈尔右翼中旗","察哈尔右翼后旗","丰镇市"],
  ...
  "黑龙江省": {
    ...
    "伊春市": ["伊美区","乌翠区","友好区","金林区","汤旺县","丰林县","南岔县","大箐山县","嘉荫县","铁力市"],
    "佳木斯市": ["前进区","向阳区","东风区","郊区","桦南县","桦川县","汤原县","同江市","富锦市","抚远市"],
  ...
  "安徽省": {
    ...
    "芜湖市": ["镜湖区","弋江区","鸠江区","三山区","湾沚区","繁昌区","南陵县","无为市"],
  ...
  "山东省": {
    ...
    "济宁市": ["任城区","兖州区","曲阜市","泗水县","邹城市","微山县","鱼台县","金乡县","嘉祥县","汶上县","梁山县"],
  ...
  "河南省": {
    ...
    "洛阳市": ["老城区","西工区","瀍河回族区","涧西区","洛龙区","孟津区","偃师区","新安县","栾川县","嵩县","汝阳县","宜阳县","洛宁县","伊川县"],
  ...
  "广东省": {
    ...
    "东莞市": ["莞城街道","南城街道","东城街道","万江街道","长安镇","虎门镇","厚街镇","寮步镇","塘厦镇","常平镇","大朗镇","凤岗镇","清溪镇","大岭山镇","黄江镇","樟木头镇","石碣镇","茶山镇","石排镇","横沥镇","东坑镇","企石镇","桥头镇","沙田镇","道滘镇","中堂镇","高埗镇","麻涌镇","望牛墩镇","洪梅镇","谢岗镇"],
    "中山市": ["石岐街道","东区街道","西区街道","南区街道","火炬开发区","小榄镇","古镇镇","三乡镇","坦洲镇","港口镇","沙溪镇","横栏镇","大涌镇","黄圃镇","南头镇","东凤镇","阜沙镇","南朗镇","民众镇","板芙镇","神湾镇"],
    "潮州市": ["湘桥区","潮安区","饶平县"],
  ...
  "海南省": {
    ...
    "三沙市": ["西沙群岛","南沙群岛","中沙群岛"],
    "儋州市": ["儋州市"],
    "省直辖县级行政区": ["五指山市","琼海市","文昌市","万宁市","东方市","定安县","屯昌县","澄迈县","临高县","白沙黎族自治县","昌江黎族自治县","乐东黎族自治县","陵水黎族自治县","保亭黎族苗族自治县","琼中黎族苗族自治县"]
  },
  "四川省": {
  ...
  "云南省": {
    ...
    "红河哈尼族彝族自治州": ["蒙自市","个旧市","开远市","弥勒市","建水县","石屏县","泸西县","元阳县","红河县","绿春县","金平苗族瑶族傣族自治县","屏边苗族自治县","河口瑶族自治县"],
  ...
  "新疆维吾尔自治区": {
    ...
    "自治区直辖县级市": ["石河子市","阿拉尔市","图木舒克市","五家渠市","北屯市","铁门关市","双河市","可克达拉市","昆玉市","胡杨河市","新星市"]
  },
  "香港特别行政区": {
    "香港岛": ["中西区","湾仔区","东区","南区"],
    "九龙": ["油尖旺区","深水埗区","九龙城区","黄大仙区","观塘区"],
    "新界": ["沙田区","大埔区","北区","元朗区","屯门区","西贡区","荃湾区","葵青区","离岛区"]
  },
  "澳门特别行政区": {
...
export const provinceList = Object.keys(raw).sort();
